...
float verticesBox[24] = {8.0f,-4.0f,10.0f,   //0
		8.0f,4.0f,10.0f,     //1
		-8.0f,-4.0f,10.0f,   //2
		-8.0f,4.0f,10.0f,	//3
		8.0f,4.0f,-10.0f,	//4
...
//		glVertexAttribPointer(0, 3, GL_FLOAT, false, 0, gTriangleVertices);
		glVertexAttribPointer(gvPositionHandle, 3, GL_FLOAT, GL_FALSE, 0, verticesBox);
