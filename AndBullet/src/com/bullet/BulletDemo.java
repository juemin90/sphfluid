...
public class BulletDemo extends Activity {
	...
	private ToggleButton btnToggleBlurThick;
    ...
    private void initId(){
           ...
           btnToggleBlurThick = (ToggleButton) findViewById(R.id.btn_toggle_blur_thick);
           ...
           btnToggleBlurThick.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			
			public void onCheckedChanged(CompoundButton buttonView, final boolean isChecked) {
				glView.queueEvent(new Runnable() {
					@Override
					public void run() {
						bulletRenderer.blurThick(isChecked);
					}
				});
			}
		});
